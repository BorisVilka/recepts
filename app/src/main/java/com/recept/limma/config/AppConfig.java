package com.recept.limma.config;

public class AppConfig {

    //your Server Key obtained from the admin panel
    public static final String SERVER_KEY = "WVVoU01HTklUVFpNZVRsellWY3hkRmxYTVd4YVIyeG9URzVLTVV3eVJuZGpRemw1V2xkT2JHTklVbVpaV0VKM1lrZHNhbGxZVW5CaU1qVktXa1k1YW1JeU1IVmpiVlpxV2xoQ01FeHRlSEJpVnpGbw==";

    //your Rest API Key obtained from the admin panel
    public static final String REST_API_KEY = "cda11Xf8LPyelhsAMSqzRVgCOvNIoj0QbG7wYcxk4raKdBTt9H";

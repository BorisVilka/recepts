...
import static com.recept.limma.utils.Constant.NATIVE_AD_HOME;
...
import com.recept.limma.activities.ActivityCategoryDetail;
import com.recept.limma.activities.ActivityRecipeDetail;
import com.recept.limma.activities.ActivityRecipeList;
import com.recept.limma.activities.MainActivity;
import com.recept.limma.adapters.AdapterFeatured;
import com.recept.limma.adapters.AdapterHomeCategory;
import com.recept.limma.adapters.AdapterHomeRecipes;
...
import com.recept.limma.utils.RtlViewPager;
...
public class FragmentHome extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        NativeAdLoader loader = new NativeAdLoader(requireActivity());

        loader.setNativeAdLoadListener(new NativeAdLoadListener() {
            @Override
            public void onAdLoaded(@NonNull NativeAd nativeAd) {
                NativeBannerView nativeBannerView = root_view.findViewById(R.id.native1);
        ...
        loader.loadAd(new NativeAdRequestConfiguration.Builder("R-M-2191535-2").build());
